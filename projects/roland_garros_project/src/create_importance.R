# Code taken from: https://github.com/skoval/iid/blob/master/code/create_importance.R
# Importance matrices
game_win <- function(p = .65, serve, return, tiebreak = FALSE){
...
save(tb_outcomes, outcomes, file = "/Users/petertea/tennis_analytics/projects/roland_garros_tracking_data/src/importance.RData")
