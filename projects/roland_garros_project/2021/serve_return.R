...
my_match_id <- 'year_2021_SM020_tracking_data.json'
...
# -- Kenin vs. Sakkari (Jun 7th) -----
my_match_id <- 'wta_year_2021_SD010_tracking_data.json'
...
server.labs <- c("Sakkari's Serve Returns", "Kenin's Serve Returns")
names(server.labs) <- c("M.SAKKARI", "S.KENIN")
...
my_plotx <- 
  ...
  labs(x = "", 
       y = "",
       title = "Serve Returns KENIN (USA) vs. SAKKARI (GRE) \n Set Number: {closest_state}",
       caption = 'Data: 2021 Roland Garros'
  )

animate(my_plotx, duration = 12, fps = 10, units = 'in', res = 200,
        width = 6, height = 4,
        renderer = gifski_renderer('/Users/petertea/tennis_analytics/projects/roland_garros_project/2021/plots/kenin_sakkari.gif'))



# -- Nadal vs. Sinner (Jun 7th) -----
my_match_id <- 'year_2021_SM010_tracking_data.json'
...
server.labs <- c("Nadal's Serve Returns", "Sinner's Serve Returns")
names(server.labs) <- c("R.NADAL", "J.SINNER")
...
my_plotx <- 
  ...
  labs(x = "", 
       y = "",
       title = "Serve Returns NADAL (ESP) vs. SINNER (ITA) \n Set Number: {closest_state}",
       caption = 'Data: 2021 Roland Garros'
  )

animate(my_plotx, duration = 12, fps = 10, units = 'in', res = 200,
        width = 6, height = 4,
        renderer = gifski_renderer('/Users/petertea/tennis_analytics/projects/roland_garros_project/2021/plots/nadal_sinner.gif'))
