#### Code Taken from Kovalchik -- trying to add point importance features
...
save(tb_outcomes, outcomes, file = "/Users/petertea/tennis_analytics/projects/roland_garros_tracking_data/point_importance/importance.RData")
