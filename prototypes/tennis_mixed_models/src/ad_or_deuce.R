...
# -- Was the Serve played on the Advantage court or on Deuce Court?
...
ad_or_deuce <- function(server_score, returner_score){
  ...
  # Args:
  # -----
  # server_score [int] or [str]: Server CURRENT score  
  # returner_score [int] or [str]: Returner CURRENT score  
  
  # Returns:
  # --------
  # str: 'Advantage' or 'Deuce'
